    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Kiev', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='64606', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='KG8 Aennue', max_length=150, verbose_name='Street Address')),
                ...
                ('plot_area', models.DecimalField(decimal_places=2, default=0.0, max_digits=8, verbose_name='Plot area(mˆ2)')),
                ...
                ('bathrooms', models.DecimalField(decimal_places=2, default=1.0, max_digits=6, verbose_name='Bathrooms')),
